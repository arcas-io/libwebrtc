...
std::shared_ptr<ArcasVideoFrameEncodedImageData> create_arcas_encoded_image(const webrtc::EncodedImage& encoded_image,
                                                                            const webrtc::CodecSpecificInfo& codec_specific_info)
{
    auto internal = rtc::make_ref_counted<ArcasVideoFrameEncodedImageDataInternal>(encoded_image, codec_specific_info);
