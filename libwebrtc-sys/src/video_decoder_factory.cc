...
webrtc::VideoDecoderFactory::CodecSupport ArcasVideoDecoderFactory::QueryCodecSupport(const webrtc::SdpVideoFormat& format,
...
std::unique_ptr<webrtc::VideoDecoder> ArcasVideoDecoderFactory::CreateVideoDecoder(const webrtc::SdpVideoFormat& format)
{
