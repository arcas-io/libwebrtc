...
public:
    ArcasVideoFrameTypesCollection(rust::Vec<webrtc::VideoFrameType> types)
...
public:
    ...
    : capabilities_(loss_notification)
    , settings_(capabilities_, number_of_cores, max_payload_size)
    {
    }
...
public:
    ...
    : builder(std::make_unique<webrtc::VideoFrame::Builder>())
    {
    }
